...
export function changeRole(player, role, notify = false) {
    ...
    player.sendMessage(`§r§l§e[§bROLE§e]§r §aRole kamu sekarang adalah ${roleFormat}`);
    // Apply To Server
    MechAPI.changePlayerRole(player, role);
}
