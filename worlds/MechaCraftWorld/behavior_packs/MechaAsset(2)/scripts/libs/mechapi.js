...
class MechAPI {
    ...
    static async getUser(player) {
        ...
        if (response.status == 200) {
            ...
            if (resp.code == 200) {
                ...
                return { status: false, message: "Gagal mendapatkan player", no_player: true };
            }
        }
        else {
            showErrorToOP("Galat:" + viewObj(response));
    ...
    static changePlayerRole(player, role) {
    ...
    static async transfer(player, targetName, amount) {
        const data = {
            xuid: player.id,
    ...
    static async gift(player, amount) {
        const data = {
            xuid: player.id,
            amount: Number(amount),
        };
        const response = await this.postRequest(player, "/api/v1/transaction/gift", data);
        if (response.status == 200) {
            const resp = JSON.parse(response.body);
            if (resp.code == 200) {
                return { status: true, result: resp.result };
                ...
                return { status: false, message: "Gagal gift uang" };
            }
        }
        else {
            showErrorToOP("Galat:" + viewObj(response));
    ...
    static async getTransactions(player) {
        const response = await this.getRequest(player, "/api/v1/transaction/" + player.id);
        if (response.status == 200) {
            const resp = JSON.parse(response.body);
            if (resp.code == 200) {
                return { status: true, result: resp.result };
                ...
                return { status: false, message: "Gagal mengambil data transaksi" };
            }
        }
        else {
            showErrorToOP("Galat:" + viewObj(response));
    ...
    static async deleteTransactionHistory(player) {
        const data = {
            xuid: player.id,
        };
        const response = await this.deleteRequest(player, "/api/v1/transaction", data);
        if (response.status == 200) {
            const resp = JSON.parse(response.body);
            if (resp.code == 200) {
                return { status: true, result: resp.result };
                ...
                return { status: false, message: "Gagal menghapus transaksi" };
            }
        }
        else {
            showErrorToOP("Galat:" + viewObj(response));
    ...
    // WARP
    static async getWarpPoint(player) {
        const response = await this.getRequest(player, "/api/v1/warps");
        if (response.status == 200) {
            const resp = JSON.parse(response.body);
            if (resp.code == 200) {
                return { status: true, result: resp.result };
                ...
                return { status: false, message: "Gagal mengambil data warp" };
            }
        }
        else {
            showErrorToOP("Galat:" + viewObj(response));
    ...
    static async setWarpPoint(player, name, texture, gamemode, active) {
        const data = {
            name,
            texture,
            gamemode,
        ...
        const response = await this.postRequest(player, "/api/v1/warp", data);
        if (response.status == 200) {
            const resp = JSON.parse(response.body);
            if (resp.code == 200) {
                return { status: true, result: resp.result };
                ...
                return { status: false, message: "Gagal menambah data warp" };
            }
        }
        else {
            showErrorToOP("Galat:" + viewObj(response));
    ...
    static async updateWarpPoint(player, id, name, texture, gamemode, updateCoor, active) {
        var data = {};
        if (updateCoor) {
            data = {
                id,
        ...
        const response = await this.putRequest(player, "/api/v1/warp", data);
        if (response.status == 200) {
            const resp = JSON.parse(response.body);
            if (resp.code == 200) {
                return { status: true, result: resp.result };
                ...
                return { status: false, message: "Gagal mengubah data warp" };
            }
        }
        else {
            showErrorToOP("Galat:" + viewObj(response));
    ...
    static async deleteWarpPoint(player, warpId) {
        const response = await this.deleteRequest(player, "/api/v1/warp/" + warpId);
        if (response.status == 200) {
            const resp = JSON.parse(response.body);
            if (resp.code == 200) {
                return { status: true, result: resp.result };
                ...
                return { status: false, message: "Gagal menghapus data warp" };
            }
        }
        else {
            showErrorToOP("Galat:" + viewObj(response));
